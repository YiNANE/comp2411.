-- =========================================================
-- CMMS Test & Verification Script
-- Extracted from original test.sql (test and query parts)
-- Run AFTER cmms_schema.sql and cmms_seed.sql
-- =========================================================
...
-- (Admin insertion is now in cmms_schema.sql)
